...
class CustomTabsHelper {
    ...
    companion object {
         ...
         */
        fun openCustomTab(context: Context, customTabsIntent: CustomTabsIntent, uri: Uri, fallback: CustomTabFallback?) {
    ...
    fun setConnectionCallback(connectionCallback: ConnectionCallback) {
        this@CustomTabsHelper.connectionCallback = connectionCallback
    }
